...
# Pre-generate variable names to avoid string manipulation overhead during timing
var_names=()
for i in {1..40}; do var_names+=("var_$i"); done

echo "--- Bash Benchmark (N=$N, 40 items) ---"

# --- CASE 1: Direct Variable Access (Hardcoded) ---
# We use a function to keep the logic clean, though the operations are hardcoded.
